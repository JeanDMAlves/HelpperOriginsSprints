...
const item_por_id = (array: Array<object>, id:number):object => {
...
// A
const id_para_bio = (array: Array<object>, id:number):string => {
    // Retorna a biografia através do ID
    return item_por_id(array, id)['bio']
}

// B
const id_para_nome = (array: Array<object>, id:number):string => {
    // Retorna o nome através do ID
    return item_por_id(array, id)['name']
}

// C
const apaga_item = (array: Array<object>, id:number): Array<object> => {
...
// D
const altera_item = (array: Array<object>, id: number, opcao: string, alteracao: string) => {
